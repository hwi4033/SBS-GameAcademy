namespace Class4th__Iteration_Statement_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // for 문의 경우 조건이 끝나는 형태와 반대로 초기식을 연산하게 되면
            ...
            //     if(i == 3)
            //     {
            //         continue;   // continue를 만나면 증감식으로 이동한다.
            //     }
            //     Console.Write(i + " ");
            // }
            #endregion
            ...
            #region 자료형 변환
            // 서로 다른 자료형을 가지고 있는 변수끼리 연산이 이루어질 때 기존에 지정했던 자료형을 다른 자료형을 변환하는 과정입니다.
            ...
            // 표현 범위가 작은 데이터에 표현 범위가 큰 데이터를 저장하게 되면 암묵적으로 데이터 손실이 발생할 수 있습니다.

            // float fat = 5.75f;
            // int weight = fat;    (X)

            // 정수형에서 실수형으로 암묵적 형 변환은 가능하지만,
            ...
            // float rate = (float)health / armor;     // 하나의 자료형만 명시적 형변환을 해도 연산중에 암묵적 형변환이 일어난다.
